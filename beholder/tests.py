...
class ContentTests(TestCase):
    def setUp(self):
        ...
        self.testPoem = Content.objects.create(title = "Raven",
                            ...
                            slug = "raven",
                            pub_date = datetime.date(2021, 8, 10),
                            page = 2,
                            css_class = 'poem',
                            body = "poem goes here")
    ...
    def test_pub_date(self):
        self.assertEqual(str(self.testPoem.pub_date), "2021-08-10")

    def test_css_class(self):
        self.assertEqual(self.testPoem.get_content_class(), 'poem')

    def test_default_metades(self):
        self.assertEqual(self.testPoem.metades, "magazine page")    
